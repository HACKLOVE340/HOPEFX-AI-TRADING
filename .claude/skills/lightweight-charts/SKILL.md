...
## Extended recipes and answer contract

Load this reference when implementing a worked example or preparing a final charting answer.

Read `references/recipes-and-answer-contract.md` for the detailed material moved out of this overview.
