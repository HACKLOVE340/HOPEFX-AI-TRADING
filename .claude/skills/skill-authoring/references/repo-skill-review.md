...
Use this reference when the task is to review a repository-managed skill collection such as `.claude/skills/` for quality, redundancy, trigger overlap, structure issues, or weak behavioral guidance.
...
- check the quality of `.claude/skills`
...
Typical overlap patterns in `.claude/skills`:
...
1. List all candidate skills under `.claude/skills/`
