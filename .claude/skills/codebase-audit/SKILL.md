...
| Security severity classification | `references/security-severity-checklist.md` |
...
Scope examples: `security`, `deps`, `error-handling`, `type-safety`, `code-quality`, `risk`, `execution`, `ml`, `api`, `data-layer`
