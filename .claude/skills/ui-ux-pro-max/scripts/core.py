...
# Trimmed to the stacks this repository actually uses: frontend/ is React 19 +
# Vite + Tailwind (+ shadcn patterns), mobile-app/ is React Native + Expo.
# Upstream also ships astro, vue, nuxtjs, nuxt-ui, svelte, swiftui, flutter, and
# jetpack-compose; re-add both the CSV and the entry here if a stack is adopted.
STACK_CONFIG = {
