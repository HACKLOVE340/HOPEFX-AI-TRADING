...
## Extended review references

Load this reference when writing the final review, handling difficult feedback, or using the review templates.

Read `references/review-templates-and-summary.md` for the detailed material moved out of this overview.
