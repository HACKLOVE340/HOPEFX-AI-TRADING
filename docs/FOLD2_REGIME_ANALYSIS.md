...
| `ml/saved_models/horizon5_training_report.json` | Full fold metrics (generated by `ml/train_advanced.py`) |
| `ml/saved_models/mtf_meta.json` | MTF ensemble OOS metrics |
