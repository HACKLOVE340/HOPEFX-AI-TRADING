...
Redis, and a 193-feature stacking ensemble (56.5% OOS accuracy, p=0.0000).
...
| OOS accuracy | 56.5% (p=0.0000, N=2,016 bars) — see `ml/saved_models/advanced_oos_meta.json` |
