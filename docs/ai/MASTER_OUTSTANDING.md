...
| Modules with recorded coverage debt | 224 | `docs/COVERAGE_UNMEASURABLE.txt` · `scripts/pre_commit_coverage.py` |

**The 224 is not 224 untested modules.** Every entry was recorded because
