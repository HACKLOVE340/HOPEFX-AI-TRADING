...
**103 tracked · OPEN 1 · PARTIAL 7 · OWNER 7 · UNVERIFIED 0 · FIXED 88**
...
- **Measured now** 31 token-reading utilities against 714 inline fontSize and 1090 numeric spacing utilities — 1804 sizes the density control cannot reach
...
- **Priority** OWNER · **Area** ML
- **Measured now** the shipped model is 176 days old against a 30-day limit
...
- **Measured now** all 942 documented keys appear in the source
...
- **Priority** P2 · **Area** Tests
- **Measured now** all 934 unit-test files that define a test also assert
...
- **Measured now** no emoji remain in frontend/src
