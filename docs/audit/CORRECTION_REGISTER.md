...
**98 tracked · OPEN 1 · PARTIAL 8 · OWNER 7 · UNVERIFIED 0 · FIXED 82**
...
- **Priority** P0 · **Area** Money
- **Measured now** the wallet ledger has 1 production consumer(s): api/billing.py
...
- **Priority** P2 · **Area** Tests
- **Measured now** all 914 unit-test files that define a test also assert
