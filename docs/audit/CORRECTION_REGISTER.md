...
**99 tracked · OPEN 2 · PARTIAL 8 · OWNER 7 · UNVERIFIED 0 · FIXED 82**
...
- **Measured now** get_balance promises 'wallet balance' and reads the broker account; the ledger the withdrawal path debits is a different number
...
- **Priority** P2 · **Area** Tests
- **Measured now** all 915 unit-test files that define a test also assert
