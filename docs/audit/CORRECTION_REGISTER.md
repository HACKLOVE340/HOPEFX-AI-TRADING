...
**78 tracked · OPEN 1 · PARTIAL 11 · OWNER 5 · UNVERIFIED 0 · FIXED 61**
...
- **Measured now** all 47 ORM tables across 2 models module(s) are created by a migration; pinned by tests/unit/test_schema_migration_check.py
...
- **Priority** P2 · **Area** Tests
- **Measured now** all 893 unit-test files that define a test also assert
...
- **Measured now** every migration that creates one of the 47 ORM tables checks first, so a create_all() database can be brought under migration control
