...
_EPISODES: list[dict[str, Any]] = [
    {
        "episode": 1, "title": "Introduction to HOPEFX", "level": "Beginner",
        "duration_min": 15, "plan": "free", "status": "script_ready",
        "summary": "What HOPEFX is, the four-layer architecture, and a live demo of signals and the ML model.",
        "chapters": ["0:00 Introduction", "1:00 What is HOPEFX?", "4:00 Architecture overview", "8:00 Live demo", "12:00 What's next"],
        "thumbnail_text": "HOPEFX AI Trading — 56.5% OOS Accuracy",
        "video_url": None,
    },
    {
        "episode": 2, "title": "Installation & Setup", "level": "Beginner",
        "duration_min": 20, "plan": "free", "status": "script_ready",
        "summary": "Clone, install, configure the .env secrets, run migrations and verify a green health check.",
        "chapters": ["0:00 Introduction", "2:00 Prerequisites check", "2:30 Clone and install", "8:00 Environment configuration", "13:00 Database setup and first run", "17:00 Verify the installation"],
        "thumbnail_text": "Install HOPEFX in 5 minutes",
        "video_url": None,
    },
    {
        "episode": 3, "title": "Your First Backtest", "level": "Beginner",
        "duration_min": 25, "plan": "free", "status": "script_ready",
        "summary": "Smoke test, real 50-year gold backtest, running it via the API, and how to read the results honestly.",
        "chapters": ["0:00 Introduction", "3:00 What is backtesting?", "3:30 Smoke test (30 seconds)", "10:00 Real data backtest", "18:00 Backtest via the API", "22:00 Interpreting results"],
        "thumbnail_text": "Backtest 50 Years of Gold Data",
        "video_url": None,
    },
    {
        "episode": 4, "title": "Interactive Charting", "level": "Beginner–Intermediate",
        "duration_min": 30, "plan": "starter", "status": "script_ready",
        "summary": "The chart engine, adding indicators, themes/export and live updates over the WebSocket feed.",
        "chapters": ["0:00 Introduction", "5:00 Creating a candlestick chart", "15:00 Adding indicators", "22:00 Themes and export", "22:30 Real-time chart via WebSocket"],
        "thumbnail_text": "Professional Charts in Python",
        "video_url": None,
    },
    {
        "episode": 5, "title": "Technical Indicators Deep Dive", "level": "Intermediate",
        "duration_min": 45, "plan": "starter", "status": "script_ready",
        "summary": "Every built-in indicator explained: moving averages, oscillators, volatility, trend and volume.",
        "chapters": ["0:00 Introduction", "0:30 Moving averages", "10:00 Oscillators", "20:00 Volatility", "30:00 Trend", "38:00 Volume"],
        "thumbnail_text": "All 20+ Indicators Explained",
        "video_url": None,
    },
    {
        "episode": 6, "title": "Building Your First Strategy", "level": "Intermediate",
        "duration_min": 45, "plan": "starter", "status": "script_ready",
        "summary": "Write a BaseStrategy subclass, generate signals, register it and backtest it end-to-end.",
        "chapters": ["0:00 Introduction", "8:00 Strategy structure (BaseStrategy)", "20:00 Signal generation logic", "30:00 Register and test", "30:30 Backtest the strategy"],
        "thumbnail_text": "Build a Trading Strategy in Python",
        "video_url": None,
    },
    {
        "episode": 7, "title": "SMC/ICT Strategy", "level": "Advanced",
        "duration_min": 60, "plan": "enterprise", "status": "script_ready",
        "summary": "Smart Money Concepts: order blocks, fair value gaps, liquidity sweeps, the 8 optimal setups, and fusing SMC with ML.",
        "chapters": ["0:00 Introduction", "15:00 SMC theory", "15:30 Order blocks", "20:00 Fair value gaps", "25:00 Liquidity sweeps", "30:00 Built-in SMC strategy", "45:00 ITS-8-OS", "55:00 Combining SMC with ML"],
        "thumbnail_text": "Smart Money Concepts in Python",
        "video_url": None,
    },
    {
        "episode": 8, "title": "ML Trading Introduction", "level": "Intermediate",
        "duration_min": 35, "plan": "professional", "status": "script_ready",
        "summary": "Why ML for trading, the production model, the feature categories, and the abstain mechanism.",
        "chapters": ["0:00 Introduction", "8:00 Why ML for trading?", "8:30 The production model", "18:00 Feature categories", "28:00 The abstain mechanism"],
        "thumbnail_text": "56.5% OOS Accuracy — How It Works",
        "video_url": None,
    },
    {
        "episode": 9, "title": "Training the ML Model", "level": "Advanced",
        "duration_min": 50, "plan": "elite", "status": "script_ready",
        "summary": "When to retrain, the smoke test, a full production retrain, verifying the new model and fallback behaviour.",
        "chapters": ["0:00 Introduction", "5:00 When to retrain", "5:30 Smoke test first", "20:00 Full production retrain", "40:00 Verify the new model", "48:00 Fallback behaviour"],
        "thumbnail_text": "Train Your Own AI Trading Model",
        "video_url": None,
    },
    {
        "episode": 10, "title": "Connecting OANDA", "level": "Beginner",
        "duration_min": 30, "plan": "starter", "status": "script_ready",
        "summary": "Create a practice account, configure credentials, validate connectivity and the 30-day paper-trading gate.",
        "chapters": ["0:00 Introduction", "5:00 Create a practice account", "12:00 Configure credentials", "20:00 Validate connectivity", "28:00 The 30-day paper trading gate"],
        "thumbnail_text": "Connect OANDA in 10 Minutes",
        "video_url": None,
    },
    {
        "episode": 11, "title": "Risk Management Masterclass", "level": "All levels",
        "duration_min": 50, "plan": "starter", "status": "script_ready",
        "summary": "Kelly position sizing, daily loss/drawdown limits, the 8-step CVaR pre-trade gate, and the kill switch.",
        "chapters": ["0:00 Introduction", "10:00 Position sizing (Kelly)", "20:00 Daily loss & drawdown limits", "30:00 The 8-step pre-trade gate (CVaR)", "40:00 Kill switch", "40:30 VaR and CVaR explained"],
        "thumbnail_text": "Never Blow Your Account Again",
        "video_url": None,
    },
    {
        "episode": 12, "title": "Deploying to Production", "level": "Advanced",
        "duration_min": 40, "plan": "professional", "status": "script_ready",
        "summary": "Pre-deployment checklist, Docker Compose, Nginx + TLS, and monitoring with Grafana/Prometheus.",
        "chapters": ["0:00 Introduction", "8:00 Pre-deployment checklist", "20:00 Docker Compose deployment", "30:00 Nginx + TLS", "30:30 Monitoring"],
        "thumbnail_text": "Deploy HOPEFX to a VPS",
        "video_url": None,
    },
    {
        "episode": 13, "title": "Prop Firm Challenge Guide", "level": "Intermediate",
        "duration_min": 45, "plan": "professional", "status": "script_ready",
        "summary": "Prop firm rules (FTMO, MyFF, The5ers, TopStep), prop-firm mode config, monitoring progress and a passing strategy.",
        "chapters": ["0:00 Introduction", "10:00 Prop firm rules overview", "25:00 Configure prop firm mode", "40:00 Monitor challenge progress", "40:30 Strategy for passing"],
        "thumbnail_text": "Pass Your Prop Firm Challenge with AI",
        "video_url": None,
    },
    {
        "episode": 14, "title": "Social Trading & Copy Trading", "level": "Intermediate",
        "duration_min": 30, "plan": "professional", "status": "script_ready",
        "summary": "Opt into the social feed, browse the leaderboard, follow traders and set up automatic copy trading.",
        "chapters": ["0:00 Introduction", "8:00 Opt in to the social feed", "18:00 Browse the leaderboard", "25:00 Follow a trader", "25:30 Auto copy trading setup"],
        "thumbnail_text": "Copy the Best Traders Automatically",
        "video_url": None,
    },
    {
        "episode": 15, "title": "Monitoring with Grafana", "level": "Advanced",
        "duration_min": 35, "plan": "professional", "status": "script_ready",
        "summary": "Start Grafana/Prometheus, walk the trading/ML/health dashboards and wire up Telegram + email alerts.",
        "chapters": ["0:00 Introduction", "8:00 Start Grafana and Prometheus", "15:00 Trading Performance dashboard", "22:00 ML Model Metrics dashboard", "28:00 System Health dashboard", "30:00 Setting up alerts"],
...
if _FASTAPI_AVAILABLE:
    ...
    async def get_tutorial(
        episode: int, user: TokenPayload = Depends(get_current_user)
    ) -> dict[str, Any]:
