...
class TestKillSwitch:
    def test_activate_persists_to_state_file(self, tmp_path):
        ...
        ks1 = KillSwitch(flag_file=flag, deactivation_token="test-token-abc")  # noqa: S106
        ...
        ks2 = KillSwitch(flag_file=flag, deactivation_token="test-token-abc")  # noqa: S106
    ...
    def test_deactivate_requires_token(self, tmp_path):
        ...
        ks = KillSwitch(flag_file=flag, deactivation_token="correct-token")  # noqa: S106
        ks.activate("test")

        # Wrong token must raise PermissionError or return falsy — never silently deactivate
        try:
            result = ks.deactivate("wrong-token")  # noqa: F841
