...
class TestStressScenario:
    def test_scenario_fields(self):
        ...
        s = StressScenario(name="TEST", description="desc", gold_shock_pct=-10.0, dxy_shock_pct=5.0)
        assert s.name == "TEST"
...
class TestStressTester:
    ...
    def test_gate_check_fails_on_large_loss(self):
        ...
        tester = StressTester(position_value=100_000.0, equity=100_000.0, max_loss_pct=0.001)
    ...
    def test_gate_check_passes_on_small_position(self):
        ...
        tester = StressTester(position_value=100.0, equity=1_000_000.0, max_loss_pct=0.20)
    ...
    def test_custom_scenarios(self):
        ...
        tester = StressTester(position_value=10_000.0, equity=100_000.0, scenarios=custom)
        results = tester.run_all()
    ...
    def test_geopolitical_spike_is_positive(self):
        ...
        tester = StressTester(position_value=10_000.0, equity=100_000.0, scenarios=[spike])
        results = tester.run_all()
    ...
    def test_gate_check_with_override_equity(self):
        ...
        tester = StressTester(position_value=100_000.0, equity=100_000.0, max_loss_pct=0.50)
