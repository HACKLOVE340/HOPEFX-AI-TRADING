...
class TestConnect:
    ...
    async def test_returns_true_when_already_connected(self):
        ...
        import brokers.ibkr as _ibkr_mod

        with patch("brokers.ibkr._IB_AVAILABLE", True), patch.object(_ibkr_mod, "IB", MagicMock()) as mock_ib_cls:
            result = await broker.connect()
        # Must short-circuit and never instantiate IB again
...
class TestBuildHelpers:
    ...
    def test_build_ib_order_market(self):
        ...
        with patch("brokers.ibkr._IB_AVAILABLE", True), patch.object(_ibkr, "MarketOrder", mock_mo):
            broker._build_ib_order("BUY", 1.0, "MARKET", {})
    ...
    def test_build_ib_order_limit(self):
        ...
        with patch("brokers.ibkr._IB_AVAILABLE", True), patch.object(_ibkr, "LimitOrder", mock_lo):
    ...
    def test_build_ib_order_stop(self):
        ...
        with patch("brokers.ibkr._IB_AVAILABLE", True), patch.object(_ibkr, "StopOrder", mock_so):
    ...
    def test_build_ib_order_stop_limit(self):
        ...
        with patch("brokers.ibkr._IB_AVAILABLE", True), patch.object(_ibkr, "StopLimitOrder", mock_slo):
    ...
    def test_build_gold_contract_futures(self):
        ...
        with patch("brokers.ibkr._IB_AVAILABLE", True), patch.object(_ibkr, "Future", mock_future):
    ...
    def test_build_gold_contract_spot(self):
        ...
        with patch("brokers.ibkr._IB_AVAILABLE", True), patch.object(_ibkr, "Commodity", mock_commodity):
