...
class TestBacktestEngine:
    ...
    def test_backtest_result_dataclass(self):
        ...
        r = BacktestResult(total_return=0.05, sharpe_ratio=1.2,
                           max_drawdown=0.03, win_rate=0.55, total_trades=10)
...
class TestIBKRFeedClasses:
    def _tick(self):
        ...
        return Tick(symbol="XAUUSD", bid=1999.0, ask=2001.0, last=2000.0,
                    timestamp=time.time())
    ...
    def test_ohlcv_bar_dataclass(self):
        ...
        bar = OHLCVBar(symbol="XAUUSD", timeframe="1m", open=2000.0, high=2005.0, low=1998.0, close=2003.0, volume=500, tick_count=10, bar_open_ts=time.time(), bar_close_ts=time.time()+60)
    ...
    def test_feed_health_dataclass(self):
        ...
        h = FeedHealth(status=FeedStatus.DISCONNECTED, last_tick_ts=None,
                       ticks_received=0, ticks_rejected=0,
                       redis_publish_errors=0, last_error=None)
    ...
    def test_tick_validator_stale(self):
        ...
        t = Tick(symbol="XAUUSD", bid=1999.0, ask=2001.0, last=2000.0,
