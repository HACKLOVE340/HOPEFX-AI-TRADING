...
_positive_float = st.floats(min_value=0.01, max_value=1_000_000.0,
                             allow_nan=False, allow_infinity=False)
_probability = st.floats(min_value=0.01, max_value=0.99,
                          allow_nan=False, allow_infinity=False)
_small_pct = st.floats(min_value=0.0, max_value=0.5,
                        allow_nan=False, allow_infinity=False)
...
@given(
    ...
    current_dd_fraction=st.floats(min_value=0.61, max_value=0.99,
                                   allow_nan=False, allow_infinity=False),
)
@settings(max_examples=100, deadline=500)
