...
class TestMarketDataCacheInit:
    ...
    def test_init_custom_params(self, mock_connect):
        ...
        cache = MarketDataCache(
            ...
            port=6380,
            db=2,
            password="secret",  # nosec B106 - test file
            socket_timeout=10,
            max_retries=5,
            retry_delay=0.5,
        )
...
class TestAPIConfigExtended:
    ...
    def test_validate_missing_api_key(self):
        cfg = APIConfig(provider="p", api_key="", api_secret="s")  # nosec B106 - test file
    ...
    def test_validate_missing_provider(self):
        cfg = APIConfig(provider="", api_key="k", api_secret="s")  # nosec B106 - test file
        assert cfg.validate() is False

    def test_validate_valid_config(self):
        cfg = APIConfig(provider="binance", api_key="key", api_secret="secret")  # nosec B106 - test file
        assert cfg.validate() is True

    def test_defaults_sandbox_true(self):
        cfg = APIConfig(provider="p", api_key="k", api_secret="s")  # nosec B106 - test file
...
class TestDatabaseConfigExtended:
    ...
    def _pg(self):
        return DatabaseConfig(
            ...
            port=5432,
            username="user",
            password="pass",  # nosec B106 - test file
            database="hopefx",
        )
    ...
    def test_unsupported_db_type_validate(self):
        cfg = DatabaseConfig(
            ...
            port=1521,
            username="u",
            password="p",  # nosec B106 - test file
            database="d",
        )
        assert cfg.validate() is False
...
class TestAppConfigValidation:
    ...
    def test_validate_with_valid_api_config(self):
        ...
        cfg.api_configs["binance"] = APIConfig(
            provider="binance", api_key="k", api_secret="s"  # nosec B106 - test file
        )
        assert cfg.validate() is True
...
class TestConfigManagerSaveConfig:
    ...
    def test_save_encrypts_api_credentials(self, tmp_path):
        ...
        cfg.api_configs["binance"] = APIConfig(
            provider="binance", api_key="myapikey", api_secret="mysecret"  # nosec B106 - test file
        )
        mgr.save_config(cfg)
...
class TestConfigManagerAPICredentials:
    ...
    def test_update_api_credential_updates_existing(self, tmp_path):
        ...
        assert cfg.api_secret == "newsecret"  # nosec B105 - test file
...
class TestEncryptDecryptIntegration:
    ...
    def test_api_credentials_survive_save_load(self, tmp_path):
        ...
        cfg.api_configs["alpaca"] = APIConfig(
            provider="alpaca", api_key="real_api_key", api_secret="real_api_secret"  # nosec B106 - test file
        )
        mgr.save_config(cfg)
        ...
        assert loaded.api_configs["alpaca"].api_secret == "real_api_secret"  # nosec B105 - test file
    ...
    def test_database_password_survives_save_load(self, tmp_path):
        ...
        cfg.database = DatabaseConfig(
            ...
            port=5432,
            username="admin",
            password="s3cr3t",  # nosec B106 - test file
            database="hopefx",
        )
        mgr.save_config(cfg)
        ...
        assert loaded.database.password == "s3cr3t"  # nosec B105 - test file
