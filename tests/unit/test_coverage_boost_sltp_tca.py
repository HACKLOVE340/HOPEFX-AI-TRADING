...
class TestTCAEngineRecordComplete:
    ...
    async def test_get_benchmark_vwap(self):
        ...
        result = await eng._get_benchmark_price("XAUUSD", BenchmarkType.VWAP, now, now)
    ...
    async def test_get_benchmark_twap(self):
        ...
        result = await eng._get_benchmark_price("XAUUSD", BenchmarkType.TWAP, now, now)
