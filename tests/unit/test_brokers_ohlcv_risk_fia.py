...
class TestBarsToDF:
    ...
    def test_epoch_timestamp(self):
        ...
        bar = {"ts": 1700000000.0, "open": 1950.0, "high": 1960.0, "low": 1940.0, "close": 1955.0, "volume": 100.0}
        df = _bars_to_df([bar])
        assert df is not None
    ...
    def test_bar_open_ts_key(self):
        ...
        bar = {"bar_open_ts": 1700000000.0, "o": 1950.0, "h": 1960.0, "l": 1940.0, "c": 1955.0, "v": 100.0}
        df = _bars_to_df([bar])
        assert df is not None
...
class TestFIAComplianceManager:
    ...
    def test_validate_order_full_pipeline(self):
        ...
        market = {"mid": 1950.0, "bid": 1949.5, "ask": 1950.5, "timestamp": datetime.now(UTC)}
