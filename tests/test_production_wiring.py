...
class TestInferenceEngine:
    def test_predict_returns_correct_shape(self):
        ...
        required = {"direction", "probability", "confidence", "model_version",
                    "bars_used", "last_close", "latency_ms", "fallback",
                    "macro_active", "mtf_active", "online_active"}
    ...
    def test_health_returns_expected_keys(self):
        ...
        engine = InferenceEngine()
        h = engine.health()
        for key in ("model_available", "model_version", "predict_count",
                    "fallback_count", "threshold_long", "threshold_short"):
