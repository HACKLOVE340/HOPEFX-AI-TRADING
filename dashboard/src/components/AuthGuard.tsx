...
import { useStore, selectIsAuth } from '../store/useStore';

interface AuthGuardProps {
  children: React.ReactNode;
  requiredRole?: import('../store/useStore').UserRole;
}

const ROLE_RANK: Record<import('../store/useStore').UserRole, number> = {
  user:       0,
  trader:     1,
  admin:      2,
  superadmin: 3,
