...
class RegimeConditionalModel(BaseEstimator, ClassifierMixin):
        ...
        for regime in [REGIME_MEAN_REVERTING, REGIME_TRENDING, REGIME_MIXED]:
            ...
            if n < MIN_REGIME_SAMPLES:
                logger.info(
                    ...
                    REGIME_NAMES[regime], n, MIN_REGIME_SAMPLES,
                )
                continue

            logger.info(
                "Training %s model on %d samples...",
                REGIME_NAMES[regime], n,
            )
    ...
    def evaluate(self, X: pd.DataFrame, y: pd.Series) -> Dict:
        ...
        result = {
            ...
            "mean_reverting": _metrics((labels == REGIME_MEAN_REVERTING).values, "mean_reverting"),
...
def walk_forward_regime_eval(
    ...
    for fold, (train_idx, test_idx) in enumerate(tscv.split(X)):
        ...
        logger.info(
            ...
            fold + 1, n_splits,
            overall["accuracy"], overall["f1"], overall.get("auc", 0.5),
