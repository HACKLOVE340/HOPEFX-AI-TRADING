...
class StripeManager:
    ...
    async def create_strategy_product(
        ...
        try:
            ...
            result = {"product_id": product.id, "price_monthly_id": monthly_price.id}
    ...
    async def create_customer(
        self, email: str, user_id: str, payment_method_id: Optional[str] = None
    ) -> str:
        """
        ...
        try:
            ...
            # Create new customer
            customer_data = {"email": email, "metadata": {"hopefx_user_id": user_id}}
