...
class RiskMetrics:
    ...
    def __init__(
        self, confidence: float = 0.95, horizon_days: int = 1, simulations: int = 10000
    ):
    ...
    def calculate_drawdown(self, equity_curve: np.ndarray) -> dict[str, float]:
        """
    ...
    def stress_test(
        self, returns: np.ndarray, shocks: dict[str, float] | None = None
    ) -> dict[str, float]:
        """
