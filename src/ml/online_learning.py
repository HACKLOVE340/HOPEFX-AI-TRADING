...
class OnlineLearningWorker:
    ...
    async def start(self) -> None:
        ...
        # Start loops
        await asyncio.gather(self._retrain_loop(), self._drift_detection_loop())
    ...
    def _create_initial_model(self) -> EnsembleModel:
        ...
        ensemble.add_model("lstm", LSTMModel(input_size=32, sequence_length=50))
    ...
    async def _retrain(self) -> None:
        ...
        y = (
            (features_df["target_1h"] > 0).astype(int).values
