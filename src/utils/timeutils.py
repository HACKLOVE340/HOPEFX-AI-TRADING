...
def is_market_open(dt: datetime | None = None, market: str = "forex") -> bool:
    """
...
def get_next_market_open(dt: datetime | None = None) -> datetime:
    ...
    elif local_dt.weekday() == 6 and local_dt.time() < time(
        17, 0
    ):  # Sunday before open
...
def trading_days(
    start: datetime, end: datetime, frequency: str = "D"
...
def align_to_bar(dt: datetime, frequency: str = "1min") -> datetime:
