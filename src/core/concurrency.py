...
class AtomicDecimal:
    ...
    async def compare_and_swap(self, expected: Decimal, new_value: Decimal) -> bool:
...
class SequentialExecutor:
    ...
    async def execute(self, key: str, coro: Any) -> Any:
    ...
    async def execute_many(self, items: list[tuple[str, Any]]) -> list[Any]:
