...
vi.mock('../hooks/useApi', () => ({
  ...
  marketplaceApi: {
    strategies:      (params?: object) => mockApiGet('/monetization/marketplace/strategies', { params }),
    strategy:        (id: string) => mockApiGet(`/monetization/marketplace/strategies/${id}`),
    purchase:        (payload: object) => mockApiPost('/monetization/marketplace/purchase', payload),
    featured:        () => mockApiGet('/monetization/marketplace/featured'),
    stats:           () => mockApiGet('/monetization/marketplace/stats'),
    list:            (payload: object) => mockApiPost('/monetization/marketplace/list', payload),
    myStrategies:    (userId: string) => mockApiGet(`/monetization/marketplace/strategies?creator_id=${userId}`),
    review:          (strategyId: string, payload: object) => mockApiPost(`/monetization/marketplace/strategies/${strategyId}/reviews`, payload),
