/**
 * ModelHealthWorkspace — the trading "brain" surface: live ML safety
 ...
 *
 * Rendered as the 'Model Health' workspace of the AI Command Center.
 *
...
export const ModelHealthWorkspace: React.FC = () => {
