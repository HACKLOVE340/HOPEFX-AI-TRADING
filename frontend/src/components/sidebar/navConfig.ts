...
export const NAV_ITEMS: NavItem[] = [
  ...
  { path: '/strategy-builder', label: 'Strategy Builder', icon: '🧩', group: 'tools', plan: 'professional', featureKey: 'strategy-builder' },
  ...
  { path: '/news',         label: 'News & Sentiment', icon: '📰', group: 'analytics', plan: 'free'  },
  ...
  { path: '/ml-ops',        label: 'ML-Ops',        icon: '🤖', group: 'admin', adminOnly: true },
