...
const s: Record<string, React.CSSProperties> = {
  ...
  countLabel: { fontSize: 9, color: 'var(--text-faint)', letterSpacing: 1.5, fontWeight: 700 },
  ...
  sectionLabel: { fontSize: 9, color: 'var(--text-faint)', letterSpacing: 2, fontWeight: 700 },
