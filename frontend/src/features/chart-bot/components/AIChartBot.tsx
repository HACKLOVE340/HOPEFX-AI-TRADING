...
const ab: Record<string, React.CSSProperties> = {
  ...
  regimeBadge: {
    ...
    fontFamily: '"JetBrains Mono", monospace',
    fontSize: 'var(--fs-micro)', fontWeight: 700, letterSpacing: '0.06em',
  },
  ...
  summaryText: {
    ...
    fontSize: 'var(--fs-body)', color: COLORS.text.primary,
  ...
  driverItem: {
    ...
    fontFamily: '"Inter", sans-serif', fontSize: 'var(--fs-label)',
  ...
  targetPrice: { fontFamily: '"JetBrains Mono", monospace', fontSize: 'var(--fs-body)', fontWeight: 700 },
  ...
  riskText: { fontFamily: '"Inter", sans-serif', fontSize: 'var(--fs-label)', color: COLORS.text.secondary, lineHeight: 1.5, margin: '4px 0 0' },
  warningsBox: { display: 'flex', flexDirection: 'column', gap: 4 },
  warning: {
    display: 'flex', alignItems: 'flex-start', gap: 6,
    fontFamily: '"Inter", sans-serif', fontSize: 'var(--fs-micro)',
    color: COLORS.neon.amber, lineHeight: 1.4,
    background: `${COLORS.neon.amber}0d`,
    border: `1px solid ${COLORS.neon.amber}33`,
    borderRadius: 4, padding: '5px 8px',
  },
  warnIcon: { flexShrink: 0, fontSize: 'var(--fs-micro)'},
  ...
  promptTitle: { fontFamily: '"JetBrains Mono", monospace', fontSize: 'var(--fs-body)', color: COLORS.text.secondary, margin: 0, letterSpacing: '0.04em' },
  promptSub: { fontFamily: '"Inter", sans-serif', fontSize: 'var(--fs-label)', color: COLORS.text.muted, margin: 0, lineHeight: 1.6, maxWidth: 260 },
  ...
  loadingTitle: { fontFamily: '"JetBrains Mono", monospace', fontSize: 'var(--fs-micro)', color: COLORS.neon.purple, letterSpacing: '0.1em' },
  ...
  loadingVal: { fontFamily: '"JetBrains Mono", monospace', fontSize: 'var(--fs-body)', color: COLORS.text.primary, fontWeight: 700 },
  ...
  loadingStepText: { fontFamily: '"JetBrains Mono", monospace', fontSize: 'var(--fs-micro)', color: COLORS.text.muted },
  ...
  errorText: { fontFamily: '"Inter", sans-serif', fontSize: 'var(--fs-label)', color: COLORS.text.secondary, textAlign: 'center' },
  retryBtn: {
    background: COLORS.bg.elevated,
    border: `1px solid ${COLORS.bg.divider}`,
    borderRadius: 4, color: COLORS.text.secondary,
    cursor: 'pointer', fontFamily: '"JetBrains Mono", monospace',
    fontSize: 'var(--fs-micro)', padding: '5px 12px', letterSpacing: '0.06em',
  },
};
