...
const SENT_COLOR: Record<string, string> = {
  bullish: 'var(--gain)', positive: 'var(--gain)', bearish: 'var(--loss)', negative: 'var(--loss)', neutral: 'var(--text-dim)',
};
const IMPACT_COLOR: Record<string, string> = { high: 'var(--loss)', medium: 'var(--warn)', low: 'var(--text-muted)' };
...
const NewsSentiment: React.FC = () => {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 900, margin: '0 auto', color: 'var(--text)' }}>
      ...
      {loading && <div style={{ color: 'var(--text-muted)', padding: 20 }}>Loading news…</div>}
      {!loading && err && (
