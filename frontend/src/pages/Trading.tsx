    ...
    <div className="flex items-center gap-3 px-3 py-2 bg-[#0a1628] border-b border-[#1e2d3d] shrink-0 flex-wrap">
      ...
      {account && (
        <div className="flex items-center gap-4 text-[11px]">
          ...
          <span className="text-slate-500">P&L <span className={cn('font-semibold', account.daily_pnl == null ? 'text-slate-400' : account.daily_pnl >= 0 ? 'text-[#00e676]' : 'text-[#ff1744]')}>{fmtPnl(account.daily_pnl)}</span></span>
        </div>
      )}
