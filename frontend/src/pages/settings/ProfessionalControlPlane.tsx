...
const styles: Record<string, React.CSSProperties> = { stack: { display: 'flex', flexDirection: 'column', gap: 16 }, header: { display: 'flex', justifyContent: 'space-between', gap: 20, alignItems: 'flex-start' }, eyebrow: { color: '#60a5fa', fontSize: 11, fontWeight: 800, letterSpacing: '.12em' }, title: { margin: '6px 0', color: '#f8fafc', fontSize: 25, textTransform: 'capitalize' }, muted: { color: '#94a3b8', fontSize: 13, lineHeight: 1.5 }, grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 12 }, card: { background: '#0f172a', border: '1px solid #1e293b', borderRadius: 12, padding: 16 }, row: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, color: '#e2e8f0' }, warning: { padding: 14, borderRadius: 10, border: '1px solid #92400e', background: '#451a03', color: '#fef3c7', fontSize: 13, lineHeight: 1.5 }, alert: { padding: 20, borderRadius: 12, border: '1px solid #7f1d1d', background: '#450a0a', color: '#fecaca' }, button: { border: 0, borderRadius: 8, padding: '10px 14px', background: '#2563eb', color: '#fff', fontWeight: 700, cursor: 'pointer' }, textarea: { width: '100%', minHeight: 92, marginTop: 12, padding: 12, borderRadius: 8, border: '1px solid #334155', background: '#020617', color: '#e2e8f0', resize: 'vertical', fontFamily: 'inherit', boxSizing: 'border-box' }, actionRow: { display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', marginTop: 12 }, pre: { margin: 0, whiteSpace: 'pre-wrap', color: '#cbd5e1', fontSize: 12, fontFamily: 'monospace' }, audit: { display: 'grid', gridTemplateColumns: '1fr auto', gap: 5, padding: '12px 0', borderBottom: '1px solid #1e293b', color: '#e2e8f0' } };
