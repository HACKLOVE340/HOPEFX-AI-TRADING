...
const SubAccounts: React.FC = () => {
  ...
  return (
    <div style={s.page}>
      ...
      {/* Cross-links */}
      <div style={{ borderTop: '1px solid #1e293b', paddingTop: 20, marginBottom: 32 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 10 }}>
          {[
            { icon: '📊', label: 'Portfolio',     desc: 'View positions and P&L',         to: '/portfolio' },
            { icon: '💳', label: 'Wallet',         desc: 'Deposits and withdrawals',       to: '/wallet' },
            { icon: '📋', label: 'Trade Journal',  desc: 'Review trade history',           to: '/journal' },
            { icon: '👥', label: 'Copy Trading',   desc: 'Follow top traders',             to: '/copy-trading' },
            { icon: '⚙️', label: 'Settings',       desc: 'Account preferences',            to: '/settings' },
            { icon: '🏆', label: 'Elite',          desc: 'Elite tier benefits',            to: '/elite' },
