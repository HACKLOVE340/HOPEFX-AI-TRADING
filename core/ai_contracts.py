...
_ALLOWED_TRANSITIONS: dict[StrategyLifecycle, frozenset[StrategyLifecycle]] = {
    ...
    StrategyLifecycle.VALIDATED: frozenset({StrategyLifecycle.PAPER_PENDING, StrategyLifecycle.RETIRED}),
    StrategyLifecycle.PAPER_PENDING: frozenset({StrategyLifecycle.PAPER_ACTIVE, StrategyLifecycle.RETIRED}),
    StrategyLifecycle.PAPER_ACTIVE: frozenset({StrategyLifecycle.LIVE_PENDING_APPROVAL, StrategyLifecycle.RETIRED}),
    StrategyLifecycle.LIVE_PENDING_APPROVAL: frozenset({StrategyLifecycle.LIVE_APPROVED, StrategyLifecycle.RETIRED}),
...
class PromotionRequest:
    ...
    def validate(self) -> None:
        ...
        if self.target == StrategyLifecycle.LIVE_APPROVED and (self.approval is None or self.approval.scope != "live"):
